...
const (
	// Label holds the string label denoting the orderproducts type in the database.
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "order_products"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"order_order_products",
...
// OrderOption defines the ordering options for the OrderProducts queries.
